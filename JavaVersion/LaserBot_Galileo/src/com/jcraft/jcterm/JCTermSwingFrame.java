...
public final class JCTermSwingFrame extends JFrame
    ...
    public void run() {
        ...
        while (thread != null) {
            try {
                ...
                frame.setTitle("[" + (counter++) + "] " + user + "@" + host + (port != 22 ? (":" + Integer.toString(port)) : ""));
                term.requestFocus();
    ...
    public JMenuBar getJMenuBar() {
        ...
        final ActionListener mcolor_action = (ActionEvent e) -> {
        ...
        final ActionListener mfsize_action = (ActionEvent e) -> {

...
public class EmulatorVT100 extends Emulator {
    ...
    private final static byte[] ENTER = {(byte) 0x0d};
    private final static byte[] UP = {(byte) 0x1b, (byte) 0x4f, (byte) 0x41};
    private final static byte[] DOWN = {(byte) 0x1b, (byte) 0x4f, (byte) 0x42};
    private final static byte[] RIGHT = {(byte) 0x1b, (byte)/*0x5b*/ 0x4f, (byte) 0x43};
    private final static byte[] LEFT = {(byte) 0x1b, (byte)/*0x5b*/ 0x4f, (byte) 0x44};
    private final static byte[] F1 = {(byte) 0x1b, (byte) 0x4f, (byte) 'P'};
    private final static byte[] F2 = {(byte) 0x1b, (byte) 0x4f, (byte) 'Q'};
    private final static byte[] F3 = {(byte) 0x1b, (byte) 0x4f, (byte) 'R'};
    private final static byte[] F4 = {(byte) 0x1b, (byte) 0x4f, (byte) 'S'};
    private final static byte[] F5 = {(byte) 0x1b, (byte) 0x4f, (byte) 't'};
    private final static byte[] F6 = {(byte) 0x1b, (byte) 0x4f, (byte) 'u'};
    private final static byte[] F7 = {(byte) 0x1b, (byte) 0x4f, (byte) 'v'};
    private final static byte[] F8 = {(byte) 0x1b, (byte) 0x4f, (byte) 'I'};
    private final static byte[] F9 = {(byte) 0x1b, (byte) 0x4f, (byte) 'w'};
    private final static byte[] F10 = {(byte) 0x1b, (byte) 0x4f, (byte) 'x'};
    private final static byte[] tab = {(byte) 0x09};

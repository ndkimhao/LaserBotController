...
public final class JCTermSwing extends JPanel implements KeyListener, /*Runnable,*/
        Term {
    ...
    private java.awt.Color bground = defaultbground;
    private java.awt.Color fground = defaultfground;
    ...
    public void sendCommand(String command) {
        try {
            byte[] goo = command.getBytes("EUC-JP");
            out.write(goo, 0, goo.length);
            out.flush();

            byte[] code = emulator.getCodeENTER();
            out.write(code, 0, code.length);
            out.flush();
        } catch (Exception eee) {
        }
